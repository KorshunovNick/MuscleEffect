...
const Calories = () => {
  ...
  return (
    <div className={styles.calories}>
      <form className={styles.form} onSubmit={clickHendler}>
        ...
        <select name="activity" id="activity" required>
          <option value="1.2">Физическая активность отсутствует</option>
          <option value="1.38">
        ...
        <div>
          ...
          <p>
            Cуточная норма:{" "}
            <span className={styles.ccalResult}>{ccalCount}</span> ккал
          </p>
        </div>
      </form>
    </div>
